...
return [
    ...
    'webtitle' => env('WEB_TITLE'),
    'startdate' => env('APP_STARTDATE'),
    'enddate' => env('APP_ENDDATE'),
    //Gigya
    ...
    //Line
    'lineurl' => env('LINE_URL'),
    'line_login_clientid' => env('LINE_LOGIN_CLIENTID'),
