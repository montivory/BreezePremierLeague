@production
    <!-- OneTrust Cookies Consent Notice start for ulmysg.com -->
    <script src="https://cdn.cookielaw.org/scripttemplates/otSDKStub.js" data-document-language="true"
        type="text/javascript" charset="UTF-8" data-domain-script="fe1676b4-f264-4af5-84f9-b3cd7302ea60"></script>
    <script type="text/javascript">
        function OptanonWrapper() {}
    </script>
    <!-- OneTrust Cookies Consent Notice end for ulmysg.com -->
    <script>
        function isMobile() {
            var check = false;
            (function(a) {
        ...
        digitalData = {
            ...
            page: {
                pageInfo: {
                    destinationURL: "https://www.unileverprokhum.com"
                },
                category: {}
            },
            video: [],
        ...
        digitalData.page.category.pageType = "Landing page";
    ...
    <script src="//assets.adobedtm.com/e6bd1902389a/6591e905cbe8/launch-5a2746f77bbc.min.js" sync></script>
@endproduction
